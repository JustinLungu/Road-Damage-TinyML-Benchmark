...
from src.constants import (
    CUSTOM_IMAGE_CLASSIFICATION_MODELS as CUSTOM_IMAGE_CLASSIFICATION_MODEL_NAMES,
...
SHUFFLENET_MODELS = set(SHUFFLENET_MODEL_CHECKPOINTS)
INCEPTION_MODELS = set(INCEPTION_MODEL_CHECKPOINTS)
...
CUSTOM_IMAGE_CLASSIFICATION_MODELS = set(CUSTOM_IMAGE_CLASSIFICATION_MODEL_NAMES)
