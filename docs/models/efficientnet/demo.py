...
from src.constants import EFFICIENTNET_MODEL_CHECKPOINTS  # noqa: E402
...
SUPPORTED_MODEL_NAMES = tuple(EFFICIENTNET_MODEL_CHECKPOINTS)
...
def save_results_json(
    ...
    output = {
        ...
        "checkpoint": EFFICIENTNET_MODEL_CHECKPOINTS[model_name],
